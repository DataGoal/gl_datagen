CREATE SCHEMA IF NOT EXISTS development.dev_pbi_perform_cf_poc;
...
TBLPROPERTIES (
  ...
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-9a5c5cf5-bed3-4d6c-9e89-c09cd7fd2e20',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-f1bb1e1b-749f-4999-9a78-904e8967f082');
...
TBLPROPERTIES (
  ...
  'delta.minWriterVersion' = '7',
  'delta.parquet.compression.codec' = 'zstd',
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-5e0dc773-e588-4d8c-a1db-ade07203891a',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-2b0e75dc-8f1f-4779-a70f-676b227cc32a');
...
TBLPROPERTIES (
  ...
  'delta.minWriterVersion' = '7',
  'delta.parquet.compression.codec' = 'zstd',
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-3ab72f13-e073-4d91-95e6-8417c92ed0cc',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-ed0063c5-4ea6-4819-bfd7-e4d0e6bc2b4a');
...
TBLPROPERTIES (
  ...
  'delta.minWriterVersion' = '7',
  'delta.parquet.compression.codec' = 'zstd',
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-d3579e83-42dd-47a3-92da-f32e3e337bd9',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-748e816e-60ad-4dcd-8939-dbb9f52da1bc');
...
CREATE TABLE IF NOT EXISTS development.dev_pbi_perform_cf_poc.segment_profit_center_hierarchy (
  ...
  segment_profit_center_nbr STRING,
...
TBLPROPERTIES (
  ...
  'delta.minWriterVersion' = '7',
  'delta.parquet.compression.codec' = 'zstd',
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-822f8576-e324-44ce-8d8a-88da97c70737',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-0d8f4200-51e7-4ae6-8061-0bc8e51b5c97');
...
TBLPROPERTIES (
  ...
  'delta.minWriterVersion' = '7',
  'delta.parquet.compression.codec' = 'zstd',
  'delta.rowTracking.materializedRowCommitVersionColumnName' = '_row-commit-version-col-96163bd5-4886-4b70-9f9f-86b134f19917',
  'delta.rowTracking.materializedRowIdColumnName' = '_row-id-col-4e97456b-049e-4d7b-a21a-0bc8fde314b5');
...
CREATE TABLE IF NOT EXISTS development.dev_pbi_perform_cf_poc.general_ledger_fact (
...
USE SCHEMA development.dev_pbi_perform_cf_poc;
